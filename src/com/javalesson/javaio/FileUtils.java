...
//        FileSystem fileSystems = path.getFileSystem();
        ...
        System.out.println("File does not exist " + Files.notExists(path)); // если файл занят кем-то, то оба метода вернут ложь.
        ...
        Files.copy(absolutePath, filesPath.resolve(path),StandardCopyOption.REPLACE_EXISTING); // move - переместить
