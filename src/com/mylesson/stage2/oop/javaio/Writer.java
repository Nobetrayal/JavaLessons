...
public class Writer {
    public void writeWithFormatter() throws FileNotFoundException {
        Formatter formatter = new Formatter("Bank accounts");
        Scanner scanner = new Scanner(System.in);
        System.out.println("Please input client id, client name, client surname and account balance");
        int i = 0;
        while (i < 3) {
            try {
    ...
    public void writeFile(String fileName, SortedMap<AverageStudentGrade, Set<SubjectGrade>> grades) throws IOException {
